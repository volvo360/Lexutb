    ...
    internal class ManageOffice
    {
        ...
        private static void addOffice()
        {
            while (true)
            {
                ...
                {
                    if (context.ValidOffice.FirstOrDefault(x => x.Office == CommonFunction.FirstLetterToUpper(inputOffice)) == null)
                    {
                        OfficeName = CommonFunction.FirstLetterToUpper(inputOffice);

                        Office = Program.ValidOffice.Count();
                        break;
                    }
                    else
                    {
        ...
        private static void editOffice()
        {
            while (true)
            {
                ...
                {
                    var temp = context.ValidOffice.ElementAt(Program.memOffice);
                ...
                else if (idOffice >= 0 && inputOffice.Length > 0)
                {
                    try
                    {
                        var temp = context.ValidOffice.FirstOrDefault(x => x.Id == idOffice);
                        if (temp != null)
                        {
                        ...
                        else
                        {
                            ...
                            foreach (var office in context.ValidOffice.OrderBy(office => office.Office))
                            {
                ...
                else if (inputOffice.Length > 0)
                {
                    ...
                    if (Program.ValidOffice.FirstOrDefault(x => x.Office == OfficeName) != null)
                    {
                        break;
                    }
                    else
        ...
        public static void showValidateEmptyOffice()
        {
            ...
            {
                context.ValidOffice.Remove(new ValidOffice() { Id = Program.memOffice});
                return;
            }
            else
            {
                ...
                { 
                    while (true)
                    {
                        ...
                        else if (idOffice >= 0 && inputOffice.Length > 0)
                        {
                            ...
                            try
                            {
                                var temp = context.ValidOffice.FirstOrDefault(office => office.Id == idOffice);
                                if (temp != null)
                                {
                                    Program.memOffice = idOffice;
                                    Office = temp.Id;
                        ...
                        else if (inputOffice.Length > 0)
                        {
                            ...
                            if (context.ValidOffice.FirstOrDefault(x => x.Office == OfficeName) != null)
                            {
                                break;
                            }
                            else
                ...
                Program.ValidOffice.RemoveAt(Program.memOffice);
            }
        ...
        public static void deleteOffice()
        {
            ...
            { 
                while (true)
                {
                    ...
                    if (Program.memOffice >= 0)
                    {
                        var temp = context.ValidOffice.FirstOrDefault(office => office.Id == Program.memOffice);
                    ...
                    else if (inputOffice.Length > 0)
                    {
                        ...
                        else
                        {
                            ...
                            foreach (var office in Program.ValidOffice)
                            {
                                Console.WriteLine($"{i} {office.Office}");
                                i++;
                            }
        ...
        private static void showAddOffice()
        {
            ...
            //Program.ValidOffice.Add(new ValidOffice(Office, OfficeName, Country, Currency));
